...
public sealed class SM003_CreateMemory : ISchemaMigration
{
    ...
    {
        ctx.Execute(@"CREATE TABLE IF NOT EXISTS ""MemoryEntries"" (""Id"" TEXT PRIMARY KEY, ""ProjectId"" TEXT NOT NULL, ""Scope"" TEXT NOT NULL, ""Key"" TEXT NOT NULL, ""Content"" TEXT NOT NULL, ""CreatedAt"" TIMESTAMPTZ NOT NULL, ""UpdatedAt"" TIMESTAMPTZ NOT NULL, UNIQUE(""ProjectId"", ""Scope"", ""Key""));");
