...
INSERT INTO "new_BoardCard" ("artifacts", "createdAt", "id", "maxLoops", "model", "order", "pack", "parentId", "projectId", "requirement", "runId", "status", "title", "type", "worktree") SELECT "artifacts", "createdAt", "id", "maxLoops", "model", "order", "pack", "parentId", "projectId", "requirement", "runId", "status", "title", "type", "worktree" FROM "BoardCard";
