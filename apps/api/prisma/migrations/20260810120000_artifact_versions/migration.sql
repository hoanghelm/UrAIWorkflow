...
INSERT INTO "new_Artifact" ("cardId", "createdAt", "fileCount", "id", "name", "path", "preview", "projectId", "runId", "sizeBytes") SELECT "cardId", "createdAt", "fileCount", "id", "name", "path", "preview", "projectId", "runId", "sizeBytes" FROM "Artifact";
DROP TABLE "Artifact";
