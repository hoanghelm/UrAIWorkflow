...
INSERT INTO "new_BoardCard" ("createdAt", "id", "maxLoops", "model", "order", "pack", "projectId", "requirement", "runId", "status", "title") SELECT "createdAt", "id", "maxLoops", "model", "order", "pack", "projectId", "requirement", "runId", "status", "title" FROM "BoardCard";
