...
export const marketplaceSeed: Item[] = [
  // Templates (bundles of components)
  ...
  { id: "skill-caveman", kind: "skill", name: "caveman", description: "Telegraphic output style that strips filler while keeping code intact. ~65% fewer output tokens.", author: "JuliusBrussee", tags: ["tokens", "output"], stars: 92000, source: "https://claudemarketplaces.com/skills/juliusbrussee/caveman/caveman", install: "caveman" },
